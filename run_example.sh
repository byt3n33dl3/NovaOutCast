...
./CMakeBuild/novaoutcast.bin "$1" --strings=true -- -D "_WIN64" -D "_UNICODE" -D "UNICODE" -D "_WINSOCK_DEPRECATED_NO_WARNINGS"\
     "-I" "/usr/local/Cellar/llvm/9.0.1"#"/usr/lib/clang/8.0.1//include" \
     "-I" "/usr/local/Cellar/llvm/9.0.1"#"/usr/lib/clang/8.0.1/" \
     "-I" "/Users/vladimir/dev/novaoutcast/Include/msvc-14.15.26726-include"\
     "-I" "/Users/vladimir/dev/novaoutcast/Include/10.0.17134.0/ucrt" \
     "-I" "/Users/vladimir/dev/novaoutcast/Include/10.0.17134.0/shared" \
     "-I" "/Users/vladimir/dev/novaoutcast/Include/10.0.17134.0/um" \
     "-I" "/Users/vladimir/dev/novaoutcast/Include/10.0.17134.0/winrt" \
     "-w" \
